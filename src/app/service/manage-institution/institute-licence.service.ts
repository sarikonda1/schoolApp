...
export class InstituteLicenceService {
     ...
     */
    public billingCycleTypes(schoolId?: string, instituteId?: string, userId?: string, academicSessionId?: string, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public billingCycleTypes(schoolId?: string, instituteId?: string, userId?: string, 
    ...
    public billingCycleTypes(schoolId?: string, instituteId?: string, userId?: string, 
        ...
        return this.httpClient.get<any>(`${this.basePath}` + BaseModuleConfig._api_InstitutionLicence_BillingCycles,
            {
