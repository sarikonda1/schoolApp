...
export interface RoleGridView extends PagingParams {
    /**Gets or Sets Names */
    names?: string[];
...
export interface RoleResultView extends ValidationMessageView {
    /**Gets or Sets Paged List of ClassViewModels */
    pagedRoleViewModels: PagedList<RoleResultView>;
    filters: Array<any>;
}
