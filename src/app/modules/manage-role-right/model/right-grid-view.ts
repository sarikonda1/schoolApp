...
export interface RightGridView extends PagingParams {
    /**Gets or Sets Names */
    names?: string[];
...
export interface RightResultView extends ValidationMessageView {
    /**Gets or Sets Paged List of ClassViewModels */
    pagedRightViewModels: PagedList<RightResultView>;
    filters: Array<any>;
}
